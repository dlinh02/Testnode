...
-- Dumping data for table defaultdb.danhba: ~13 rows (approximately)
INSERT INTO `danhba` (`madanhba`, `chudanhba`, `manguoitrongdanhba`, `ten`, `sodienthoai`, `trangthai`) VALUES
	(1, 2, 1, 'Truong', '0905371627', 1),
	(2, 2, 3, 'Mẹ yêu', '0345607344', 0),
...
-- Dumping data for table defaultdb.danhsachthanhviennhom: ~15 rows (approximately)
...
-- Dumping data for table defaultdb.loimoidanhba: ~0 rows (approximately)
...
-- Dumping data for table defaultdb.tinnhan: ~382 rows (approximately)
